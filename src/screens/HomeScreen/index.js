...
import { ActivityIndicator, Image, LayoutAnimation, Modal, Platform, TouchableOpacity, View } from "react-native"
...
export const HomeScreen = ({ navigation }) => {
  ...
  useEffect(() => {
    dispatch(GetChargeBoxesData(`${API_URL}/charge-box/index?page=1&per-page=100&connector_types[0]=1&connector_types[1]=2&connector_types[2]=3&connector_types[3]=4&connector_types[4]=5&connector_types[5]=6&min=7&max=20&language==${countryCode}`))
    return () => {
