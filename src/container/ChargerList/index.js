...
export const ChargerList = ({
    ...
    const handleFilter = (value) => {
        if (value) {
            ...
            console.log("newDataTitle", newDataTitle)
            ...
            console.log("newDataTitle", newDataTitle)
            if (newDataTitle?.id === newDataAddress?.id) {
                setChargerListData([...newDataTitle])
            } else {
    ...
    const RenderChargerItem = ({title, address, pin, connectors, index, id}) => {
        return (
            <View
                style={{
                    width: "100%",
